...
pub const KHRONOS_FALSE = @enumToInt(khronos_boolean_enum_t.KHRONOS_FALSE);
pub const KHRONOS_TRUE = @enumToInt(khronos_boolean_enum_t.KHRONOS_TRUE);
pub const KHRONOS_BOOLEAN_ENUM_FORCE_SIZE = @enumToInt(khronos_boolean_enum_t.KHRONOS_BOOLEAN_ENUM_FORCE_SIZE);
...
pub extern var glad_glDebugMessageControlKHR: PFNGLDEBUGMESSAGECONTROLKHRPROC;
pub const PFNGLDEBUGMESSAGEINSERTKHRPROC = ?fn (GLenum, GLenum, GLuint, GLenum, GLsizei, [*c]const GLchar) callconv(.C) void;
pub extern var glad_glDebugMessageInsertKHR: PFNGLDEBUGMESSAGEINSERTKHRPROC;
pub const PFNGLDEBUGMESSAGECALLBACKKHRPROC = ?fn (GLDEBUGPROCKHR, ?*const c_void) callconv(.C) void;
pub extern var glad_glDebugMessageCallbackKHR: PFNGLDEBUGMESSAGECALLBACKKHRPROC;
...
pub const GLAPI = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // gl/glad/include/glad/glad.h:79:11
pub const __stdint_join3 = @compileError("unable to translate C expr: unexpected token .HashHash"); // D:\bin\zig-windows-x86_64-0.8.1\lib\include\stdint.h:245:9
pub const __int_c_join = @compileError("unable to translate C expr: unexpected token .HashHash"); // D:\bin\zig-windows-x86_64-0.8.1\lib\include\stdint.h:282:9
pub const __uint_c = @compileError("unable to translate C expr: expected ',' or ')'"); // D:\bin\zig-windows-x86_64-0.8.1\lib\include\stdint.h:284:9
...
pub const KHRONOS_APICALL = __declspec(dllimport);
...
pub const INT64_MAX = INT64_C(@import("std").meta.promoteIntLiteral(c_int, 9223372036854775807, .decimal));
pub const INT64_MIN = -INT64_C(@import("std").meta.promoteIntLiteral(c_int, 9223372036854775807, .decimal)) - @as(c_int, 1);
pub const UINT64_MAX = UINT64_C(@import("std").meta.promoteIntLiteral(c_int, 18446744073709551615, .decimal));
...
pub const INT32_MAX = INT32_C(@import("std").meta.promoteIntLiteral(c_int, 2147483647, .decimal));
pub const INT32_MIN = -INT32_C(@import("std").meta.promoteIntLiteral(c_int, 2147483647, .decimal)) - @as(c_int, 1);
pub const UINT32_MAX = UINT32_C(@import("std").meta.promoteIntLiteral(c_int, 4294967295, .decimal));
...
pub const UINT16_MAX = UINT16_C(@import("std").meta.promoteIntLiteral(c_int, 65535, .decimal));
...
pub const KHRONOS_MAX_ENUM = @import("std").meta.promoteIntLiteral(c_int, 0x7FFFFFFF, .hexadecimal);
...
pub const GL_SAMPLE_SHADING = @import("std").meta.promoteIntLiteral(c_int, 0x8C36, .hexadecimal);
pub const GL_MIN_SAMPLE_SHADING_VALUE = @import("std").meta.promoteIntLiteral(c_int, 0x8C37, .hexadecimal);
pub const GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x8E5E, .hexadecimal);
pub const GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x8E5F, .hexadecimal);
pub const GL_TEXTURE_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9009, .hexadecimal);
pub const GL_TEXTURE_BINDING_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x900A, .hexadecimal);
pub const GL_PROXY_TEXTURE_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x900B, .hexadecimal);
pub const GL_SAMPLER_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x900C, .hexadecimal);
pub const GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW = @import("std").meta.promoteIntLiteral(c_int, 0x900D, .hexadecimal);
pub const GL_INT_SAMPLER_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x900E, .hexadecimal);
pub const GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x900F, .hexadecimal);
pub const GL_DRAW_INDIRECT_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x8F3F, .hexadecimal);
pub const GL_DRAW_INDIRECT_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x8F43, .hexadecimal);
pub const GL_GEOMETRY_SHADER_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x887F, .hexadecimal);
pub const GL_MAX_GEOMETRY_SHADER_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x8E5A, .hexadecimal);
pub const GL_MIN_FRAGMENT_INTERPOLATION_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x8E5B, .hexadecimal);
pub const GL_MAX_FRAGMENT_INTERPOLATION_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x8E5C, .hexadecimal);
pub const GL_FRAGMENT_INTERPOLATION_OFFSET_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x8E5D, .hexadecimal);
pub const GL_MAX_VERTEX_STREAMS = @import("std").meta.promoteIntLiteral(c_int, 0x8E71, .hexadecimal);
pub const GL_DOUBLE_VEC2 = @import("std").meta.promoteIntLiteral(c_int, 0x8FFC, .hexadecimal);
pub const GL_DOUBLE_VEC3 = @import("std").meta.promoteIntLiteral(c_int, 0x8FFD, .hexadecimal);
pub const GL_DOUBLE_VEC4 = @import("std").meta.promoteIntLiteral(c_int, 0x8FFE, .hexadecimal);
pub const GL_DOUBLE_MAT2 = @import("std").meta.promoteIntLiteral(c_int, 0x8F46, .hexadecimal);
pub const GL_DOUBLE_MAT3 = @import("std").meta.promoteIntLiteral(c_int, 0x8F47, .hexadecimal);
pub const GL_DOUBLE_MAT4 = @import("std").meta.promoteIntLiteral(c_int, 0x8F48, .hexadecimal);
pub const GL_DOUBLE_MAT2x3 = @import("std").meta.promoteIntLiteral(c_int, 0x8F49, .hexadecimal);
pub const GL_DOUBLE_MAT2x4 = @import("std").meta.promoteIntLiteral(c_int, 0x8F4A, .hexadecimal);
pub const GL_DOUBLE_MAT3x2 = @import("std").meta.promoteIntLiteral(c_int, 0x8F4B, .hexadecimal);
pub const GL_DOUBLE_MAT3x4 = @import("std").meta.promoteIntLiteral(c_int, 0x8F4C, .hexadecimal);
pub const GL_DOUBLE_MAT4x2 = @import("std").meta.promoteIntLiteral(c_int, 0x8F4D, .hexadecimal);
pub const GL_DOUBLE_MAT4x3 = @import("std").meta.promoteIntLiteral(c_int, 0x8F4E, .hexadecimal);
pub const GL_ACTIVE_SUBROUTINES = @import("std").meta.promoteIntLiteral(c_int, 0x8DE5, .hexadecimal);
pub const GL_ACTIVE_SUBROUTINE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x8DE6, .hexadecimal);
pub const GL_ACTIVE_SUBROUTINE_UNIFORM_LOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x8E47, .hexadecimal);
pub const GL_ACTIVE_SUBROUTINE_MAX_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x8E48, .hexadecimal);
pub const GL_ACTIVE_SUBROUTINE_UNIFORM_MAX_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x8E49, .hexadecimal);
pub const GL_MAX_SUBROUTINES = @import("std").meta.promoteIntLiteral(c_int, 0x8DE7, .hexadecimal);
pub const GL_MAX_SUBROUTINE_UNIFORM_LOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x8DE8, .hexadecimal);
pub const GL_NUM_COMPATIBLE_SUBROUTINES = @import("std").meta.promoteIntLiteral(c_int, 0x8E4A, .hexadecimal);
pub const GL_COMPATIBLE_SUBROUTINES = @import("std").meta.promoteIntLiteral(c_int, 0x8E4B, .hexadecimal);
pub const GL_PATCHES = @as(c_int, 0x000E);
pub const GL_PATCH_VERTICES = @import("std").meta.promoteIntLiteral(c_int, 0x8E72, .hexadecimal);
pub const GL_PATCH_DEFAULT_INNER_LEVEL = @import("std").meta.promoteIntLiteral(c_int, 0x8E73, .hexadecimal);
pub const GL_PATCH_DEFAULT_OUTER_LEVEL = @import("std").meta.promoteIntLiteral(c_int, 0x8E74, .hexadecimal);
pub const GL_TESS_CONTROL_OUTPUT_VERTICES = @import("std").meta.promoteIntLiteral(c_int, 0x8E75, .hexadecimal);
pub const GL_TESS_GEN_MODE = @import("std").meta.promoteIntLiteral(c_int, 0x8E76, .hexadecimal);
pub const GL_TESS_GEN_SPACING = @import("std").meta.promoteIntLiteral(c_int, 0x8E77, .hexadecimal);
pub const GL_TESS_GEN_VERTEX_ORDER = @import("std").meta.promoteIntLiteral(c_int, 0x8E78, .hexadecimal);
pub const GL_TESS_GEN_POINT_MODE = @import("std").meta.promoteIntLiteral(c_int, 0x8E79, .hexadecimal);
pub const GL_ISOLINES = @import("std").meta.promoteIntLiteral(c_int, 0x8E7A, .hexadecimal);
pub const GL_QUADS = @as(c_int, 0x0007);
pub const GL_FRACTIONAL_ODD = @import("std").meta.promoteIntLiteral(c_int, 0x8E7B, .hexadecimal);
pub const GL_FRACTIONAL_EVEN = @import("std").meta.promoteIntLiteral(c_int, 0x8E7C, .hexadecimal);
pub const GL_MAX_PATCH_VERTICES = @import("std").meta.promoteIntLiteral(c_int, 0x8E7D, .hexadecimal);
pub const GL_MAX_TESS_GEN_LEVEL = @import("std").meta.promoteIntLiteral(c_int, 0x8E7E, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E7F, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E80, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS = @import("std").meta.promoteIntLiteral(c_int, 0x8E81, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS = @import("std").meta.promoteIntLiteral(c_int, 0x8E82, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E83, .hexadecimal);
pub const GL_MAX_TESS_PATCH_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E84, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E85, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E86, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x8E89, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x8E8A, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_INPUT_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x886C, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x886D, .hexadecimal);
pub const GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E1E, .hexadecimal);
pub const GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8E1F, .hexadecimal);
pub const GL_UNIFORM_BLOCK_REFERENCED_BY_TESS_CONTROL_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x84F0, .hexadecimal);
pub const GL_UNIFORM_BLOCK_REFERENCED_BY_TESS_EVALUATION_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x84F1, .hexadecimal);
pub const GL_TESS_EVALUATION_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x8E87, .hexadecimal);
pub const GL_TESS_CONTROL_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x8E88, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK = @import("std").meta.promoteIntLiteral(c_int, 0x8E22, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_BUFFER_PAUSED = @import("std").meta.promoteIntLiteral(c_int, 0x8E23, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_BUFFER_ACTIVE = @import("std").meta.promoteIntLiteral(c_int, 0x8E24, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x8E25, .hexadecimal);
pub const GL_MAX_TRANSFORM_FEEDBACK_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x8E70, .hexadecimal);
pub const GL_FIXED = @as(c_int, 0x140C);
pub const GL_IMPLEMENTATION_COLOR_READ_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x8B9A, .hexadecimal);
pub const GL_IMPLEMENTATION_COLOR_READ_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x8B9B, .hexadecimal);
pub const GL_LOW_FLOAT = @import("std").meta.promoteIntLiteral(c_int, 0x8DF0, .hexadecimal);
pub const GL_MEDIUM_FLOAT = @import("std").meta.promoteIntLiteral(c_int, 0x8DF1, .hexadecimal);
pub const GL_HIGH_FLOAT = @import("std").meta.promoteIntLiteral(c_int, 0x8DF2, .hexadecimal);
pub const GL_LOW_INT = @import("std").meta.promoteIntLiteral(c_int, 0x8DF3, .hexadecimal);
pub const GL_MEDIUM_INT = @import("std").meta.promoteIntLiteral(c_int, 0x8DF4, .hexadecimal);
pub const GL_HIGH_INT = @import("std").meta.promoteIntLiteral(c_int, 0x8DF5, .hexadecimal);
pub const GL_SHADER_COMPILER = @import("std").meta.promoteIntLiteral(c_int, 0x8DFA, .hexadecimal);
pub const GL_SHADER_BINARY_FORMATS = @import("std").meta.promoteIntLiteral(c_int, 0x8DF8, .hexadecimal);
pub const GL_NUM_SHADER_BINARY_FORMATS = @import("std").meta.promoteIntLiteral(c_int, 0x8DF9, .hexadecimal);
pub const GL_MAX_VERTEX_UNIFORM_VECTORS = @import("std").meta.promoteIntLiteral(c_int, 0x8DFB, .hexadecimal);
pub const GL_MAX_VARYING_VECTORS = @import("std").meta.promoteIntLiteral(c_int, 0x8DFC, .hexadecimal);
pub const GL_MAX_FRAGMENT_UNIFORM_VECTORS = @import("std").meta.promoteIntLiteral(c_int, 0x8DFD, .hexadecimal);
pub const GL_RGB565 = @import("std").meta.promoteIntLiteral(c_int, 0x8D62, .hexadecimal);
pub const GL_PROGRAM_BINARY_RETRIEVABLE_HINT = @import("std").meta.promoteIntLiteral(c_int, 0x8257, .hexadecimal);
pub const GL_PROGRAM_BINARY_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x8741, .hexadecimal);
pub const GL_NUM_PROGRAM_BINARY_FORMATS = @import("std").meta.promoteIntLiteral(c_int, 0x87FE, .hexadecimal);
pub const GL_PROGRAM_BINARY_FORMATS = @import("std").meta.promoteIntLiteral(c_int, 0x87FF, .hexadecimal);
...
pub const GL_ALL_SHADER_BITS = @import("std").meta.promoteIntLiteral(c_int, 0xFFFFFFFF, .hexadecimal);
pub const GL_PROGRAM_SEPARABLE = @import("std").meta.promoteIntLiteral(c_int, 0x8258, .hexadecimal);
pub const GL_ACTIVE_PROGRAM = @import("std").meta.promoteIntLiteral(c_int, 0x8259, .hexadecimal);
pub const GL_PROGRAM_PIPELINE_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x825A, .hexadecimal);
pub const GL_MAX_VIEWPORTS = @import("std").meta.promoteIntLiteral(c_int, 0x825B, .hexadecimal);
pub const GL_VIEWPORT_SUBPIXEL_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x825C, .hexadecimal);
pub const GL_VIEWPORT_BOUNDS_RANGE = @import("std").meta.promoteIntLiteral(c_int, 0x825D, .hexadecimal);
pub const GL_LAYER_PROVOKING_VERTEX = @import("std").meta.promoteIntLiteral(c_int, 0x825E, .hexadecimal);
pub const GL_VIEWPORT_INDEX_PROVOKING_VERTEX = @import("std").meta.promoteIntLiteral(c_int, 0x825F, .hexadecimal);
pub const GL_UNDEFINED_VERTEX = @import("std").meta.promoteIntLiteral(c_int, 0x8260, .hexadecimal);
pub const GL_COPY_READ_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x8F36, .hexadecimal);
pub const GL_COPY_WRITE_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x8F37, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_ACTIVE = @import("std").meta.promoteIntLiteral(c_int, 0x8E24, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_PAUSED = @import("std").meta.promoteIntLiteral(c_int, 0x8E23, .hexadecimal);
pub const GL_UNPACK_COMPRESSED_BLOCK_WIDTH = @import("std").meta.promoteIntLiteral(c_int, 0x9127, .hexadecimal);
pub const GL_UNPACK_COMPRESSED_BLOCK_HEIGHT = @import("std").meta.promoteIntLiteral(c_int, 0x9128, .hexadecimal);
pub const GL_UNPACK_COMPRESSED_BLOCK_DEPTH = @import("std").meta.promoteIntLiteral(c_int, 0x9129, .hexadecimal);
pub const GL_UNPACK_COMPRESSED_BLOCK_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x912A, .hexadecimal);
pub const GL_PACK_COMPRESSED_BLOCK_WIDTH = @import("std").meta.promoteIntLiteral(c_int, 0x912B, .hexadecimal);
pub const GL_PACK_COMPRESSED_BLOCK_HEIGHT = @import("std").meta.promoteIntLiteral(c_int, 0x912C, .hexadecimal);
pub const GL_PACK_COMPRESSED_BLOCK_DEPTH = @import("std").meta.promoteIntLiteral(c_int, 0x912D, .hexadecimal);
pub const GL_PACK_COMPRESSED_BLOCK_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x912E, .hexadecimal);
pub const GL_NUM_SAMPLE_COUNTS = @import("std").meta.promoteIntLiteral(c_int, 0x9380, .hexadecimal);
pub const GL_MIN_MAP_BUFFER_ALIGNMENT = @import("std").meta.promoteIntLiteral(c_int, 0x90BC, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x92C0, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x92C1, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_START = @import("std").meta.promoteIntLiteral(c_int, 0x92C2, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x92C3, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_DATA_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x92C4, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92C5, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_ACTIVE_ATOMIC_COUNTER_INDICES = @import("std").meta.promoteIntLiteral(c_int, 0x92C6, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_VERTEX_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x92C7, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_CONTROL_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x92C8, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_TESS_EVALUATION_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x92C9, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_GEOMETRY_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x92CA, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_FRAGMENT_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x92CB, .hexadecimal);
pub const GL_MAX_VERTEX_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92CC, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92CD, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92CE, .hexadecimal);
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92CF, .hexadecimal);
pub const GL_MAX_FRAGMENT_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D0, .hexadecimal);
pub const GL_MAX_COMBINED_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D1, .hexadecimal);
pub const GL_MAX_VERTEX_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D2, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D3, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D4, .hexadecimal);
pub const GL_MAX_GEOMETRY_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D5, .hexadecimal);
pub const GL_MAX_FRAGMENT_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D6, .hexadecimal);
pub const GL_MAX_COMBINED_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D7, .hexadecimal);
pub const GL_MAX_ATOMIC_COUNTER_BUFFER_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x92D8, .hexadecimal);
pub const GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS = @import("std").meta.promoteIntLiteral(c_int, 0x92DC, .hexadecimal);
pub const GL_ACTIVE_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x92D9, .hexadecimal);
pub const GL_UNIFORM_ATOMIC_COUNTER_BUFFER_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x92DA, .hexadecimal);
pub const GL_UNSIGNED_INT_ATOMIC_COUNTER = @import("std").meta.promoteIntLiteral(c_int, 0x92DB, .hexadecimal);
...
pub const GL_ALL_BARRIER_BITS = @import("std").meta.promoteIntLiteral(c_int, 0xFFFFFFFF, .hexadecimal);
pub const GL_MAX_IMAGE_UNITS = @import("std").meta.promoteIntLiteral(c_int, 0x8F38, .hexadecimal);
pub const GL_MAX_COMBINED_IMAGE_UNITS_AND_FRAGMENT_OUTPUTS = @import("std").meta.promoteIntLiteral(c_int, 0x8F39, .hexadecimal);
pub const GL_IMAGE_BINDING_NAME = @import("std").meta.promoteIntLiteral(c_int, 0x8F3A, .hexadecimal);
pub const GL_IMAGE_BINDING_LEVEL = @import("std").meta.promoteIntLiteral(c_int, 0x8F3B, .hexadecimal);
pub const GL_IMAGE_BINDING_LAYERED = @import("std").meta.promoteIntLiteral(c_int, 0x8F3C, .hexadecimal);
pub const GL_IMAGE_BINDING_LAYER = @import("std").meta.promoteIntLiteral(c_int, 0x8F3D, .hexadecimal);
pub const GL_IMAGE_BINDING_ACCESS = @import("std").meta.promoteIntLiteral(c_int, 0x8F3E, .hexadecimal);
pub const GL_IMAGE_1D = @import("std").meta.promoteIntLiteral(c_int, 0x904C, .hexadecimal);
pub const GL_IMAGE_2D = @import("std").meta.promoteIntLiteral(c_int, 0x904D, .hexadecimal);
pub const GL_IMAGE_3D = @import("std").meta.promoteIntLiteral(c_int, 0x904E, .hexadecimal);
pub const GL_IMAGE_2D_RECT = @import("std").meta.promoteIntLiteral(c_int, 0x904F, .hexadecimal);
pub const GL_IMAGE_CUBE = @import("std").meta.promoteIntLiteral(c_int, 0x9050, .hexadecimal);
pub const GL_IMAGE_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x9051, .hexadecimal);
pub const GL_IMAGE_1D_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9052, .hexadecimal);
pub const GL_IMAGE_2D_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9053, .hexadecimal);
pub const GL_IMAGE_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9054, .hexadecimal);
pub const GL_IMAGE_2D_MULTISAMPLE = @import("std").meta.promoteIntLiteral(c_int, 0x9055, .hexadecimal);
pub const GL_IMAGE_2D_MULTISAMPLE_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9056, .hexadecimal);
pub const GL_INT_IMAGE_1D = @import("std").meta.promoteIntLiteral(c_int, 0x9057, .hexadecimal);
pub const GL_INT_IMAGE_2D = @import("std").meta.promoteIntLiteral(c_int, 0x9058, .hexadecimal);
pub const GL_INT_IMAGE_3D = @import("std").meta.promoteIntLiteral(c_int, 0x9059, .hexadecimal);
pub const GL_INT_IMAGE_2D_RECT = @import("std").meta.promoteIntLiteral(c_int, 0x905A, .hexadecimal);
pub const GL_INT_IMAGE_CUBE = @import("std").meta.promoteIntLiteral(c_int, 0x905B, .hexadecimal);
pub const GL_INT_IMAGE_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x905C, .hexadecimal);
pub const GL_INT_IMAGE_1D_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x905D, .hexadecimal);
pub const GL_INT_IMAGE_2D_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x905E, .hexadecimal);
pub const GL_INT_IMAGE_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x905F, .hexadecimal);
pub const GL_INT_IMAGE_2D_MULTISAMPLE = @import("std").meta.promoteIntLiteral(c_int, 0x9060, .hexadecimal);
pub const GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9061, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_1D = @import("std").meta.promoteIntLiteral(c_int, 0x9062, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_2D = @import("std").meta.promoteIntLiteral(c_int, 0x9063, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_3D = @import("std").meta.promoteIntLiteral(c_int, 0x9064, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_2D_RECT = @import("std").meta.promoteIntLiteral(c_int, 0x9065, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_CUBE = @import("std").meta.promoteIntLiteral(c_int, 0x9066, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x9067, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_1D_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9068, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_2D_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x9069, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x906A, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE = @import("std").meta.promoteIntLiteral(c_int, 0x906B, .hexadecimal);
pub const GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x906C, .hexadecimal);
pub const GL_MAX_IMAGE_SAMPLES = @import("std").meta.promoteIntLiteral(c_int, 0x906D, .hexadecimal);
pub const GL_IMAGE_BINDING_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x906E, .hexadecimal);
pub const GL_IMAGE_FORMAT_COMPATIBILITY_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x90C7, .hexadecimal);
pub const GL_IMAGE_FORMAT_COMPATIBILITY_BY_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x90C8, .hexadecimal);
pub const GL_IMAGE_FORMAT_COMPATIBILITY_BY_CLASS = @import("std").meta.promoteIntLiteral(c_int, 0x90C9, .hexadecimal);
pub const GL_MAX_VERTEX_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x90CA, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x90CB, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x90CC, .hexadecimal);
pub const GL_MAX_GEOMETRY_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x90CD, .hexadecimal);
pub const GL_MAX_FRAGMENT_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x90CE, .hexadecimal);
pub const GL_MAX_COMBINED_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x90CF, .hexadecimal);
pub const GL_COMPRESSED_RGBA_BPTC_UNORM = @import("std").meta.promoteIntLiteral(c_int, 0x8E8C, .hexadecimal);
pub const GL_COMPRESSED_SRGB_ALPHA_BPTC_UNORM = @import("std").meta.promoteIntLiteral(c_int, 0x8E8D, .hexadecimal);
pub const GL_COMPRESSED_RGB_BPTC_SIGNED_FLOAT = @import("std").meta.promoteIntLiteral(c_int, 0x8E8E, .hexadecimal);
pub const GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT = @import("std").meta.promoteIntLiteral(c_int, 0x8E8F, .hexadecimal);
pub const GL_TEXTURE_IMMUTABLE_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x912F, .hexadecimal);
pub const GL_NUM_SHADING_LANGUAGE_VERSIONS = @import("std").meta.promoteIntLiteral(c_int, 0x82E9, .hexadecimal);
pub const GL_VERTEX_ATTRIB_ARRAY_LONG = @import("std").meta.promoteIntLiteral(c_int, 0x874E, .hexadecimal);
pub const GL_COMPRESSED_RGB8_ETC2 = @import("std").meta.promoteIntLiteral(c_int, 0x9274, .hexadecimal);
pub const GL_COMPRESSED_SRGB8_ETC2 = @import("std").meta.promoteIntLiteral(c_int, 0x9275, .hexadecimal);
pub const GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2 = @import("std").meta.promoteIntLiteral(c_int, 0x9276, .hexadecimal);
pub const GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2 = @import("std").meta.promoteIntLiteral(c_int, 0x9277, .hexadecimal);
pub const GL_COMPRESSED_RGBA8_ETC2_EAC = @import("std").meta.promoteIntLiteral(c_int, 0x9278, .hexadecimal);
pub const GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC = @import("std").meta.promoteIntLiteral(c_int, 0x9279, .hexadecimal);
pub const GL_COMPRESSED_R11_EAC = @import("std").meta.promoteIntLiteral(c_int, 0x9270, .hexadecimal);
pub const GL_COMPRESSED_SIGNED_R11_EAC = @import("std").meta.promoteIntLiteral(c_int, 0x9271, .hexadecimal);
pub const GL_COMPRESSED_RG11_EAC = @import("std").meta.promoteIntLiteral(c_int, 0x9272, .hexadecimal);
pub const GL_COMPRESSED_SIGNED_RG11_EAC = @import("std").meta.promoteIntLiteral(c_int, 0x9273, .hexadecimal);
pub const GL_PRIMITIVE_RESTART_FIXED_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x8D69, .hexadecimal);
pub const GL_ANY_SAMPLES_PASSED_CONSERVATIVE = @import("std").meta.promoteIntLiteral(c_int, 0x8D6A, .hexadecimal);
pub const GL_MAX_ELEMENT_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x8D6B, .hexadecimal);
pub const GL_COMPUTE_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x91B9, .hexadecimal);
pub const GL_MAX_COMPUTE_UNIFORM_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x91BB, .hexadecimal);
pub const GL_MAX_COMPUTE_TEXTURE_IMAGE_UNITS = @import("std").meta.promoteIntLiteral(c_int, 0x91BC, .hexadecimal);
pub const GL_MAX_COMPUTE_IMAGE_UNIFORMS = @import("std").meta.promoteIntLiteral(c_int, 0x91BD, .hexadecimal);
pub const GL_MAX_COMPUTE_SHARED_MEMORY_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8262, .hexadecimal);
pub const GL_MAX_COMPUTE_UNIFORM_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8263, .hexadecimal);
pub const GL_MAX_COMPUTE_ATOMIC_COUNTER_BUFFERS = @import("std").meta.promoteIntLiteral(c_int, 0x8264, .hexadecimal);
pub const GL_MAX_COMPUTE_ATOMIC_COUNTERS = @import("std").meta.promoteIntLiteral(c_int, 0x8265, .hexadecimal);
pub const GL_MAX_COMBINED_COMPUTE_UNIFORM_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8266, .hexadecimal);
pub const GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x90EB, .hexadecimal);
pub const GL_MAX_COMPUTE_WORK_GROUP_COUNT = @import("std").meta.promoteIntLiteral(c_int, 0x91BE, .hexadecimal);
pub const GL_MAX_COMPUTE_WORK_GROUP_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x91BF, .hexadecimal);
pub const GL_COMPUTE_WORK_GROUP_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8267, .hexadecimal);
pub const GL_UNIFORM_BLOCK_REFERENCED_BY_COMPUTE_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x90EC, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_REFERENCED_BY_COMPUTE_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x90ED, .hexadecimal);
pub const GL_DISPATCH_INDIRECT_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x90EE, .hexadecimal);
pub const GL_DISPATCH_INDIRECT_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x90EF, .hexadecimal);
pub const GL_COMPUTE_SHADER_BIT = @as(c_int, 0x00000020);
pub const GL_DEBUG_OUTPUT_SYNCHRONOUS = @import("std").meta.promoteIntLiteral(c_int, 0x8242, .hexadecimal);
pub const GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x8243, .hexadecimal);
pub const GL_DEBUG_CALLBACK_FUNCTION = @import("std").meta.promoteIntLiteral(c_int, 0x8244, .hexadecimal);
pub const GL_DEBUG_CALLBACK_USER_PARAM = @import("std").meta.promoteIntLiteral(c_int, 0x8245, .hexadecimal);
pub const GL_DEBUG_SOURCE_API = @import("std").meta.promoteIntLiteral(c_int, 0x8246, .hexadecimal);
pub const GL_DEBUG_SOURCE_WINDOW_SYSTEM = @import("std").meta.promoteIntLiteral(c_int, 0x8247, .hexadecimal);
pub const GL_DEBUG_SOURCE_SHADER_COMPILER = @import("std").meta.promoteIntLiteral(c_int, 0x8248, .hexadecimal);
pub const GL_DEBUG_SOURCE_THIRD_PARTY = @import("std").meta.promoteIntLiteral(c_int, 0x8249, .hexadecimal);
pub const GL_DEBUG_SOURCE_APPLICATION = @import("std").meta.promoteIntLiteral(c_int, 0x824A, .hexadecimal);
pub const GL_DEBUG_SOURCE_OTHER = @import("std").meta.promoteIntLiteral(c_int, 0x824B, .hexadecimal);
pub const GL_DEBUG_TYPE_ERROR = @import("std").meta.promoteIntLiteral(c_int, 0x824C, .hexadecimal);
pub const GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR = @import("std").meta.promoteIntLiteral(c_int, 0x824D, .hexadecimal);
pub const GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR = @import("std").meta.promoteIntLiteral(c_int, 0x824E, .hexadecimal);
pub const GL_DEBUG_TYPE_PORTABILITY = @import("std").meta.promoteIntLiteral(c_int, 0x824F, .hexadecimal);
pub const GL_DEBUG_TYPE_PERFORMANCE = @import("std").meta.promoteIntLiteral(c_int, 0x8250, .hexadecimal);
pub const GL_DEBUG_TYPE_OTHER = @import("std").meta.promoteIntLiteral(c_int, 0x8251, .hexadecimal);
pub const GL_MAX_DEBUG_MESSAGE_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x9143, .hexadecimal);
pub const GL_MAX_DEBUG_LOGGED_MESSAGES = @import("std").meta.promoteIntLiteral(c_int, 0x9144, .hexadecimal);
pub const GL_DEBUG_LOGGED_MESSAGES = @import("std").meta.promoteIntLiteral(c_int, 0x9145, .hexadecimal);
pub const GL_DEBUG_SEVERITY_HIGH = @import("std").meta.promoteIntLiteral(c_int, 0x9146, .hexadecimal);
pub const GL_DEBUG_SEVERITY_MEDIUM = @import("std").meta.promoteIntLiteral(c_int, 0x9147, .hexadecimal);
pub const GL_DEBUG_SEVERITY_LOW = @import("std").meta.promoteIntLiteral(c_int, 0x9148, .hexadecimal);
pub const GL_DEBUG_TYPE_MARKER = @import("std").meta.promoteIntLiteral(c_int, 0x8268, .hexadecimal);
pub const GL_DEBUG_TYPE_PUSH_GROUP = @import("std").meta.promoteIntLiteral(c_int, 0x8269, .hexadecimal);
pub const GL_DEBUG_TYPE_POP_GROUP = @import("std").meta.promoteIntLiteral(c_int, 0x826A, .hexadecimal);
pub const GL_DEBUG_SEVERITY_NOTIFICATION = @import("std").meta.promoteIntLiteral(c_int, 0x826B, .hexadecimal);
pub const GL_MAX_DEBUG_GROUP_STACK_DEPTH = @import("std").meta.promoteIntLiteral(c_int, 0x826C, .hexadecimal);
pub const GL_DEBUG_GROUP_STACK_DEPTH = @import("std").meta.promoteIntLiteral(c_int, 0x826D, .hexadecimal);
pub const GL_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x82E0, .hexadecimal);
pub const GL_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x82E1, .hexadecimal);
pub const GL_PROGRAM = @import("std").meta.promoteIntLiteral(c_int, 0x82E2, .hexadecimal);
pub const GL_VERTEX_ARRAY = @import("std").meta.promoteIntLiteral(c_int, 0x8074, .hexadecimal);
pub const GL_QUERY = @import("std").meta.promoteIntLiteral(c_int, 0x82E3, .hexadecimal);
pub const GL_PROGRAM_PIPELINE = @import("std").meta.promoteIntLiteral(c_int, 0x82E4, .hexadecimal);
pub const GL_SAMPLER = @import("std").meta.promoteIntLiteral(c_int, 0x82E6, .hexadecimal);
pub const GL_MAX_LABEL_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x82E8, .hexadecimal);
pub const GL_DEBUG_OUTPUT = @import("std").meta.promoteIntLiteral(c_int, 0x92E0, .hexadecimal);
pub const GL_CONTEXT_FLAG_DEBUG_BIT = @as(c_int, 0x00000002);
pub const GL_MAX_UNIFORM_LOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x826E, .hexadecimal);
pub const GL_FRAMEBUFFER_DEFAULT_WIDTH = @import("std").meta.promoteIntLiteral(c_int, 0x9310, .hexadecimal);
pub const GL_FRAMEBUFFER_DEFAULT_HEIGHT = @import("std").meta.promoteIntLiteral(c_int, 0x9311, .hexadecimal);
pub const GL_FRAMEBUFFER_DEFAULT_LAYERS = @import("std").meta.promoteIntLiteral(c_int, 0x9312, .hexadecimal);
pub const GL_FRAMEBUFFER_DEFAULT_SAMPLES = @import("std").meta.promoteIntLiteral(c_int, 0x9313, .hexadecimal);
pub const GL_FRAMEBUFFER_DEFAULT_FIXED_SAMPLE_LOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x9314, .hexadecimal);
pub const GL_MAX_FRAMEBUFFER_WIDTH = @import("std").meta.promoteIntLiteral(c_int, 0x9315, .hexadecimal);
pub const GL_MAX_FRAMEBUFFER_HEIGHT = @import("std").meta.promoteIntLiteral(c_int, 0x9316, .hexadecimal);
pub const GL_MAX_FRAMEBUFFER_LAYERS = @import("std").meta.promoteIntLiteral(c_int, 0x9317, .hexadecimal);
pub const GL_MAX_FRAMEBUFFER_SAMPLES = @import("std").meta.promoteIntLiteral(c_int, 0x9318, .hexadecimal);
pub const GL_INTERNALFORMAT_SUPPORTED = @import("std").meta.promoteIntLiteral(c_int, 0x826F, .hexadecimal);
pub const GL_INTERNALFORMAT_PREFERRED = @import("std").meta.promoteIntLiteral(c_int, 0x8270, .hexadecimal);
pub const GL_INTERNALFORMAT_RED_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8271, .hexadecimal);
pub const GL_INTERNALFORMAT_GREEN_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8272, .hexadecimal);
pub const GL_INTERNALFORMAT_BLUE_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8273, .hexadecimal);
pub const GL_INTERNALFORMAT_ALPHA_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8274, .hexadecimal);
pub const GL_INTERNALFORMAT_DEPTH_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8275, .hexadecimal);
pub const GL_INTERNALFORMAT_STENCIL_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8276, .hexadecimal);
pub const GL_INTERNALFORMAT_SHARED_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x8277, .hexadecimal);
pub const GL_INTERNALFORMAT_RED_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x8278, .hexadecimal);
pub const GL_INTERNALFORMAT_GREEN_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x8279, .hexadecimal);
pub const GL_INTERNALFORMAT_BLUE_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x827A, .hexadecimal);
pub const GL_INTERNALFORMAT_ALPHA_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x827B, .hexadecimal);
pub const GL_INTERNALFORMAT_DEPTH_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x827C, .hexadecimal);
pub const GL_INTERNALFORMAT_STENCIL_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x827D, .hexadecimal);
pub const GL_MAX_WIDTH = @import("std").meta.promoteIntLiteral(c_int, 0x827E, .hexadecimal);
pub const GL_MAX_HEIGHT = @import("std").meta.promoteIntLiteral(c_int, 0x827F, .hexadecimal);
pub const GL_MAX_DEPTH = @import("std").meta.promoteIntLiteral(c_int, 0x8280, .hexadecimal);
pub const GL_MAX_LAYERS = @import("std").meta.promoteIntLiteral(c_int, 0x8281, .hexadecimal);
pub const GL_MAX_COMBINED_DIMENSIONS = @import("std").meta.promoteIntLiteral(c_int, 0x8282, .hexadecimal);
pub const GL_COLOR_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8283, .hexadecimal);
pub const GL_DEPTH_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8284, .hexadecimal);
pub const GL_STENCIL_COMPONENTS = @import("std").meta.promoteIntLiteral(c_int, 0x8285, .hexadecimal);
pub const GL_COLOR_RENDERABLE = @import("std").meta.promoteIntLiteral(c_int, 0x8286, .hexadecimal);
pub const GL_DEPTH_RENDERABLE = @import("std").meta.promoteIntLiteral(c_int, 0x8287, .hexadecimal);
pub const GL_STENCIL_RENDERABLE = @import("std").meta.promoteIntLiteral(c_int, 0x8288, .hexadecimal);
pub const GL_FRAMEBUFFER_RENDERABLE = @import("std").meta.promoteIntLiteral(c_int, 0x8289, .hexadecimal);
pub const GL_FRAMEBUFFER_RENDERABLE_LAYERED = @import("std").meta.promoteIntLiteral(c_int, 0x828A, .hexadecimal);
pub const GL_FRAMEBUFFER_BLEND = @import("std").meta.promoteIntLiteral(c_int, 0x828B, .hexadecimal);
pub const GL_READ_PIXELS = @import("std").meta.promoteIntLiteral(c_int, 0x828C, .hexadecimal);
pub const GL_READ_PIXELS_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x828D, .hexadecimal);
pub const GL_READ_PIXELS_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x828E, .hexadecimal);
pub const GL_TEXTURE_IMAGE_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x828F, .hexadecimal);
pub const GL_TEXTURE_IMAGE_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x8290, .hexadecimal);
pub const GL_GET_TEXTURE_IMAGE_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x8291, .hexadecimal);
pub const GL_GET_TEXTURE_IMAGE_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x8292, .hexadecimal);
pub const GL_MIPMAP = @import("std").meta.promoteIntLiteral(c_int, 0x8293, .hexadecimal);
pub const GL_MANUAL_GENERATE_MIPMAP = @import("std").meta.promoteIntLiteral(c_int, 0x8294, .hexadecimal);
pub const GL_AUTO_GENERATE_MIPMAP = @import("std").meta.promoteIntLiteral(c_int, 0x8295, .hexadecimal);
pub const GL_COLOR_ENCODING = @import("std").meta.promoteIntLiteral(c_int, 0x8296, .hexadecimal);
pub const GL_SRGB_READ = @import("std").meta.promoteIntLiteral(c_int, 0x8297, .hexadecimal);
pub const GL_SRGB_WRITE = @import("std").meta.promoteIntLiteral(c_int, 0x8298, .hexadecimal);
pub const GL_FILTER = @import("std").meta.promoteIntLiteral(c_int, 0x829A, .hexadecimal);
pub const GL_VERTEX_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x829B, .hexadecimal);
pub const GL_TESS_CONTROL_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x829C, .hexadecimal);
pub const GL_TESS_EVALUATION_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x829D, .hexadecimal);
pub const GL_GEOMETRY_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x829E, .hexadecimal);
pub const GL_FRAGMENT_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x829F, .hexadecimal);
pub const GL_COMPUTE_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x82A0, .hexadecimal);
pub const GL_TEXTURE_SHADOW = @import("std").meta.promoteIntLiteral(c_int, 0x82A1, .hexadecimal);
pub const GL_TEXTURE_GATHER = @import("std").meta.promoteIntLiteral(c_int, 0x82A2, .hexadecimal);
pub const GL_TEXTURE_GATHER_SHADOW = @import("std").meta.promoteIntLiteral(c_int, 0x82A3, .hexadecimal);
pub const GL_SHADER_IMAGE_LOAD = @import("std").meta.promoteIntLiteral(c_int, 0x82A4, .hexadecimal);
pub const GL_SHADER_IMAGE_STORE = @import("std").meta.promoteIntLiteral(c_int, 0x82A5, .hexadecimal);
pub const GL_SHADER_IMAGE_ATOMIC = @import("std").meta.promoteIntLiteral(c_int, 0x82A6, .hexadecimal);
pub const GL_IMAGE_TEXEL_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x82A7, .hexadecimal);
pub const GL_IMAGE_COMPATIBILITY_CLASS = @import("std").meta.promoteIntLiteral(c_int, 0x82A8, .hexadecimal);
pub const GL_IMAGE_PIXEL_FORMAT = @import("std").meta.promoteIntLiteral(c_int, 0x82A9, .hexadecimal);
pub const GL_IMAGE_PIXEL_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x82AA, .hexadecimal);
pub const GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_TEST = @import("std").meta.promoteIntLiteral(c_int, 0x82AC, .hexadecimal);
pub const GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_TEST = @import("std").meta.promoteIntLiteral(c_int, 0x82AD, .hexadecimal);
pub const GL_SIMULTANEOUS_TEXTURE_AND_DEPTH_WRITE = @import("std").meta.promoteIntLiteral(c_int, 0x82AE, .hexadecimal);
pub const GL_SIMULTANEOUS_TEXTURE_AND_STENCIL_WRITE = @import("std").meta.promoteIntLiteral(c_int, 0x82AF, .hexadecimal);
pub const GL_TEXTURE_COMPRESSED_BLOCK_WIDTH = @import("std").meta.promoteIntLiteral(c_int, 0x82B1, .hexadecimal);
pub const GL_TEXTURE_COMPRESSED_BLOCK_HEIGHT = @import("std").meta.promoteIntLiteral(c_int, 0x82B2, .hexadecimal);
pub const GL_TEXTURE_COMPRESSED_BLOCK_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x82B3, .hexadecimal);
pub const GL_CLEAR_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x82B4, .hexadecimal);
pub const GL_TEXTURE_VIEW = @import("std").meta.promoteIntLiteral(c_int, 0x82B5, .hexadecimal);
pub const GL_VIEW_COMPATIBILITY_CLASS = @import("std").meta.promoteIntLiteral(c_int, 0x82B6, .hexadecimal);
pub const GL_FULL_SUPPORT = @import("std").meta.promoteIntLiteral(c_int, 0x82B7, .hexadecimal);
pub const GL_CAVEAT_SUPPORT = @import("std").meta.promoteIntLiteral(c_int, 0x82B8, .hexadecimal);
pub const GL_IMAGE_CLASS_4_X_32 = @import("std").meta.promoteIntLiteral(c_int, 0x82B9, .hexadecimal);
pub const GL_IMAGE_CLASS_2_X_32 = @import("std").meta.promoteIntLiteral(c_int, 0x82BA, .hexadecimal);
pub const GL_IMAGE_CLASS_1_X_32 = @import("std").meta.promoteIntLiteral(c_int, 0x82BB, .hexadecimal);
pub const GL_IMAGE_CLASS_4_X_16 = @import("std").meta.promoteIntLiteral(c_int, 0x82BC, .hexadecimal);
pub const GL_IMAGE_CLASS_2_X_16 = @import("std").meta.promoteIntLiteral(c_int, 0x82BD, .hexadecimal);
pub const GL_IMAGE_CLASS_1_X_16 = @import("std").meta.promoteIntLiteral(c_int, 0x82BE, .hexadecimal);
pub const GL_IMAGE_CLASS_4_X_8 = @import("std").meta.promoteIntLiteral(c_int, 0x82BF, .hexadecimal);
pub const GL_IMAGE_CLASS_2_X_8 = @import("std").meta.promoteIntLiteral(c_int, 0x82C0, .hexadecimal);
pub const GL_IMAGE_CLASS_1_X_8 = @import("std").meta.promoteIntLiteral(c_int, 0x82C1, .hexadecimal);
pub const GL_IMAGE_CLASS_11_11_10 = @import("std").meta.promoteIntLiteral(c_int, 0x82C2, .hexadecimal);
pub const GL_IMAGE_CLASS_10_10_10_2 = @import("std").meta.promoteIntLiteral(c_int, 0x82C3, .hexadecimal);
pub const GL_VIEW_CLASS_128_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82C4, .hexadecimal);
pub const GL_VIEW_CLASS_96_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82C5, .hexadecimal);
pub const GL_VIEW_CLASS_64_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82C6, .hexadecimal);
pub const GL_VIEW_CLASS_48_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82C7, .hexadecimal);
pub const GL_VIEW_CLASS_32_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82C8, .hexadecimal);
pub const GL_VIEW_CLASS_24_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82C9, .hexadecimal);
pub const GL_VIEW_CLASS_16_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82CA, .hexadecimal);
pub const GL_VIEW_CLASS_8_BITS = @import("std").meta.promoteIntLiteral(c_int, 0x82CB, .hexadecimal);
pub const GL_VIEW_CLASS_S3TC_DXT1_RGB = @import("std").meta.promoteIntLiteral(c_int, 0x82CC, .hexadecimal);
pub const GL_VIEW_CLASS_S3TC_DXT1_RGBA = @import("std").meta.promoteIntLiteral(c_int, 0x82CD, .hexadecimal);
pub const GL_VIEW_CLASS_S3TC_DXT3_RGBA = @import("std").meta.promoteIntLiteral(c_int, 0x82CE, .hexadecimal);
pub const GL_VIEW_CLASS_S3TC_DXT5_RGBA = @import("std").meta.promoteIntLiteral(c_int, 0x82CF, .hexadecimal);
pub const GL_VIEW_CLASS_RGTC1_RED = @import("std").meta.promoteIntLiteral(c_int, 0x82D0, .hexadecimal);
pub const GL_VIEW_CLASS_RGTC2_RG = @import("std").meta.promoteIntLiteral(c_int, 0x82D1, .hexadecimal);
pub const GL_VIEW_CLASS_BPTC_UNORM = @import("std").meta.promoteIntLiteral(c_int, 0x82D2, .hexadecimal);
pub const GL_VIEW_CLASS_BPTC_FLOAT = @import("std").meta.promoteIntLiteral(c_int, 0x82D3, .hexadecimal);
pub const GL_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92E1, .hexadecimal);
pub const GL_UNIFORM_BLOCK = @import("std").meta.promoteIntLiteral(c_int, 0x92E2, .hexadecimal);
pub const GL_PROGRAM_INPUT = @import("std").meta.promoteIntLiteral(c_int, 0x92E3, .hexadecimal);
pub const GL_PROGRAM_OUTPUT = @import("std").meta.promoteIntLiteral(c_int, 0x92E4, .hexadecimal);
pub const GL_BUFFER_VARIABLE = @import("std").meta.promoteIntLiteral(c_int, 0x92E5, .hexadecimal);
pub const GL_SHADER_STORAGE_BLOCK = @import("std").meta.promoteIntLiteral(c_int, 0x92E6, .hexadecimal);
pub const GL_VERTEX_SUBROUTINE = @import("std").meta.promoteIntLiteral(c_int, 0x92E8, .hexadecimal);
pub const GL_TESS_CONTROL_SUBROUTINE = @import("std").meta.promoteIntLiteral(c_int, 0x92E9, .hexadecimal);
pub const GL_TESS_EVALUATION_SUBROUTINE = @import("std").meta.promoteIntLiteral(c_int, 0x92EA, .hexadecimal);
pub const GL_GEOMETRY_SUBROUTINE = @import("std").meta.promoteIntLiteral(c_int, 0x92EB, .hexadecimal);
pub const GL_FRAGMENT_SUBROUTINE = @import("std").meta.promoteIntLiteral(c_int, 0x92EC, .hexadecimal);
pub const GL_COMPUTE_SUBROUTINE = @import("std").meta.promoteIntLiteral(c_int, 0x92ED, .hexadecimal);
pub const GL_VERTEX_SUBROUTINE_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92EE, .hexadecimal);
pub const GL_TESS_CONTROL_SUBROUTINE_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92EF, .hexadecimal);
pub const GL_TESS_EVALUATION_SUBROUTINE_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92F0, .hexadecimal);
pub const GL_GEOMETRY_SUBROUTINE_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92F1, .hexadecimal);
pub const GL_FRAGMENT_SUBROUTINE_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92F2, .hexadecimal);
pub const GL_COMPUTE_SUBROUTINE_UNIFORM = @import("std").meta.promoteIntLiteral(c_int, 0x92F3, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_VARYING = @import("std").meta.promoteIntLiteral(c_int, 0x92F4, .hexadecimal);
pub const GL_ACTIVE_RESOURCES = @import("std").meta.promoteIntLiteral(c_int, 0x92F5, .hexadecimal);
pub const GL_MAX_NAME_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x92F6, .hexadecimal);
pub const GL_MAX_NUM_ACTIVE_VARIABLES = @import("std").meta.promoteIntLiteral(c_int, 0x92F7, .hexadecimal);
pub const GL_MAX_NUM_COMPATIBLE_SUBROUTINES = @import("std").meta.promoteIntLiteral(c_int, 0x92F8, .hexadecimal);
pub const GL_NAME_LENGTH = @import("std").meta.promoteIntLiteral(c_int, 0x92F9, .hexadecimal);
pub const GL_TYPE = @import("std").meta.promoteIntLiteral(c_int, 0x92FA, .hexadecimal);
pub const GL_ARRAY_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x92FB, .hexadecimal);
pub const GL_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x92FC, .hexadecimal);
pub const GL_BLOCK_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x92FD, .hexadecimal);
pub const GL_ARRAY_STRIDE = @import("std").meta.promoteIntLiteral(c_int, 0x92FE, .hexadecimal);
pub const GL_MATRIX_STRIDE = @import("std").meta.promoteIntLiteral(c_int, 0x92FF, .hexadecimal);
pub const GL_IS_ROW_MAJOR = @import("std").meta.promoteIntLiteral(c_int, 0x9300, .hexadecimal);
pub const GL_ATOMIC_COUNTER_BUFFER_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x9301, .hexadecimal);
pub const GL_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x9302, .hexadecimal);
pub const GL_BUFFER_DATA_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x9303, .hexadecimal);
pub const GL_NUM_ACTIVE_VARIABLES = @import("std").meta.promoteIntLiteral(c_int, 0x9304, .hexadecimal);
pub const GL_ACTIVE_VARIABLES = @import("std").meta.promoteIntLiteral(c_int, 0x9305, .hexadecimal);
pub const GL_REFERENCED_BY_VERTEX_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x9306, .hexadecimal);
pub const GL_REFERENCED_BY_TESS_CONTROL_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x9307, .hexadecimal);
pub const GL_REFERENCED_BY_TESS_EVALUATION_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x9308, .hexadecimal);
pub const GL_REFERENCED_BY_GEOMETRY_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x9309, .hexadecimal);
pub const GL_REFERENCED_BY_FRAGMENT_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x930A, .hexadecimal);
pub const GL_REFERENCED_BY_COMPUTE_SHADER = @import("std").meta.promoteIntLiteral(c_int, 0x930B, .hexadecimal);
pub const GL_TOP_LEVEL_ARRAY_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x930C, .hexadecimal);
pub const GL_TOP_LEVEL_ARRAY_STRIDE = @import("std").meta.promoteIntLiteral(c_int, 0x930D, .hexadecimal);
pub const GL_LOCATION = @import("std").meta.promoteIntLiteral(c_int, 0x930E, .hexadecimal);
pub const GL_LOCATION_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x930F, .hexadecimal);
pub const GL_IS_PER_PATCH = @import("std").meta.promoteIntLiteral(c_int, 0x92E7, .hexadecimal);
pub const GL_SHADER_STORAGE_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x90D2, .hexadecimal);
pub const GL_SHADER_STORAGE_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x90D3, .hexadecimal);
pub const GL_SHADER_STORAGE_BUFFER_START = @import("std").meta.promoteIntLiteral(c_int, 0x90D4, .hexadecimal);
pub const GL_SHADER_STORAGE_BUFFER_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x90D5, .hexadecimal);
pub const GL_MAX_VERTEX_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90D6, .hexadecimal);
pub const GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90D7, .hexadecimal);
pub const GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90D8, .hexadecimal);
pub const GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90D9, .hexadecimal);
pub const GL_MAX_FRAGMENT_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90DA, .hexadecimal);
pub const GL_MAX_COMPUTE_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90DB, .hexadecimal);
pub const GL_MAX_COMBINED_SHADER_STORAGE_BLOCKS = @import("std").meta.promoteIntLiteral(c_int, 0x90DC, .hexadecimal);
pub const GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS = @import("std").meta.promoteIntLiteral(c_int, 0x90DD, .hexadecimal);
pub const GL_MAX_SHADER_STORAGE_BLOCK_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x90DE, .hexadecimal);
pub const GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT = @import("std").meta.promoteIntLiteral(c_int, 0x90DF, .hexadecimal);
pub const GL_SHADER_STORAGE_BARRIER_BIT = @as(c_int, 0x00002000);
pub const GL_MAX_COMBINED_SHADER_OUTPUT_RESOURCES = @import("std").meta.promoteIntLiteral(c_int, 0x8F39, .hexadecimal);
pub const GL_DEPTH_STENCIL_TEXTURE_MODE = @import("std").meta.promoteIntLiteral(c_int, 0x90EA, .hexadecimal);
pub const GL_TEXTURE_BUFFER_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x919D, .hexadecimal);
pub const GL_TEXTURE_BUFFER_SIZE = @import("std").meta.promoteIntLiteral(c_int, 0x919E, .hexadecimal);
pub const GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT = @import("std").meta.promoteIntLiteral(c_int, 0x919F, .hexadecimal);
pub const GL_TEXTURE_VIEW_MIN_LEVEL = @import("std").meta.promoteIntLiteral(c_int, 0x82DB, .hexadecimal);
pub const GL_TEXTURE_VIEW_NUM_LEVELS = @import("std").meta.promoteIntLiteral(c_int, 0x82DC, .hexadecimal);
pub const GL_TEXTURE_VIEW_MIN_LAYER = @import("std").meta.promoteIntLiteral(c_int, 0x82DD, .hexadecimal);
pub const GL_TEXTURE_VIEW_NUM_LAYERS = @import("std").meta.promoteIntLiteral(c_int, 0x82DE, .hexadecimal);
pub const GL_TEXTURE_IMMUTABLE_LEVELS = @import("std").meta.promoteIntLiteral(c_int, 0x82DF, .hexadecimal);
pub const GL_VERTEX_ATTRIB_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x82D4, .hexadecimal);
pub const GL_VERTEX_ATTRIB_RELATIVE_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x82D5, .hexadecimal);
pub const GL_VERTEX_BINDING_DIVISOR = @import("std").meta.promoteIntLiteral(c_int, 0x82D6, .hexadecimal);
pub const GL_VERTEX_BINDING_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x82D7, .hexadecimal);
pub const GL_VERTEX_BINDING_STRIDE = @import("std").meta.promoteIntLiteral(c_int, 0x82D8, .hexadecimal);
pub const GL_MAX_VERTEX_ATTRIB_RELATIVE_OFFSET = @import("std").meta.promoteIntLiteral(c_int, 0x82D9, .hexadecimal);
pub const GL_MAX_VERTEX_ATTRIB_BINDINGS = @import("std").meta.promoteIntLiteral(c_int, 0x82DA, .hexadecimal);
pub const GL_VERTEX_BINDING_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x8F4F, .hexadecimal);
pub const GL_DISPLAY_LIST = @import("std").meta.promoteIntLiteral(c_int, 0x82E7, .hexadecimal);
pub const GL_STACK_UNDERFLOW = @as(c_int, 0x0504);
pub const GL_STACK_OVERFLOW = @as(c_int, 0x0503);
pub const GL_MAX_VERTEX_ATTRIB_STRIDE = @import("std").meta.promoteIntLiteral(c_int, 0x82E5, .hexadecimal);
pub const GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED = @import("std").meta.promoteIntLiteral(c_int, 0x8221, .hexadecimal);
pub const GL_TEXTURE_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x8C2A, .hexadecimal);
...
pub const GL_BUFFER_IMMUTABLE_STORAGE = @import("std").meta.promoteIntLiteral(c_int, 0x821F, .hexadecimal);
pub const GL_BUFFER_STORAGE_FLAGS = @import("std").meta.promoteIntLiteral(c_int, 0x8220, .hexadecimal);
pub const GL_CLEAR_TEXTURE = @import("std").meta.promoteIntLiteral(c_int, 0x9365, .hexadecimal);
pub const GL_LOCATION_COMPONENT = @import("std").meta.promoteIntLiteral(c_int, 0x934A, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_BUFFER_INDEX = @import("std").meta.promoteIntLiteral(c_int, 0x934B, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_BUFFER_STRIDE = @import("std").meta.promoteIntLiteral(c_int, 0x934C, .hexadecimal);
pub const GL_QUERY_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x9192, .hexadecimal);
pub const GL_QUERY_BUFFER_BARRIER_BIT = @import("std").meta.promoteIntLiteral(c_int, 0x00008000, .hexadecimal);
pub const GL_QUERY_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x9193, .hexadecimal);
pub const GL_QUERY_RESULT_NO_WAIT = @import("std").meta.promoteIntLiteral(c_int, 0x9194, .hexadecimal);
pub const GL_MIRROR_CLAMP_TO_EDGE = @import("std").meta.promoteIntLiteral(c_int, 0x8743, .hexadecimal);
pub const GL_CONTEXT_LOST = @as(c_int, 0x0507);
pub const GL_NEGATIVE_ONE_TO_ONE = @import("std").meta.promoteIntLiteral(c_int, 0x935E, .hexadecimal);
pub const GL_ZERO_TO_ONE = @import("std").meta.promoteIntLiteral(c_int, 0x935F, .hexadecimal);
pub const GL_CLIP_ORIGIN = @import("std").meta.promoteIntLiteral(c_int, 0x935C, .hexadecimal);
pub const GL_CLIP_DEPTH_MODE = @import("std").meta.promoteIntLiteral(c_int, 0x935D, .hexadecimal);
pub const GL_QUERY_WAIT_INVERTED = @import("std").meta.promoteIntLiteral(c_int, 0x8E17, .hexadecimal);
pub const GL_QUERY_NO_WAIT_INVERTED = @import("std").meta.promoteIntLiteral(c_int, 0x8E18, .hexadecimal);
pub const GL_QUERY_BY_REGION_WAIT_INVERTED = @import("std").meta.promoteIntLiteral(c_int, 0x8E19, .hexadecimal);
pub const GL_QUERY_BY_REGION_NO_WAIT_INVERTED = @import("std").meta.promoteIntLiteral(c_int, 0x8E1A, .hexadecimal);
pub const GL_MAX_CULL_DISTANCES = @import("std").meta.promoteIntLiteral(c_int, 0x82F9, .hexadecimal);
pub const GL_MAX_COMBINED_CLIP_AND_CULL_DISTANCES = @import("std").meta.promoteIntLiteral(c_int, 0x82FA, .hexadecimal);
pub const GL_TEXTURE_TARGET = @as(c_int, 0x1006);
pub const GL_QUERY_TARGET = @import("std").meta.promoteIntLiteral(c_int, 0x82EA, .hexadecimal);
pub const GL_GUILTY_CONTEXT_RESET = @import("std").meta.promoteIntLiteral(c_int, 0x8253, .hexadecimal);
pub const GL_INNOCENT_CONTEXT_RESET = @import("std").meta.promoteIntLiteral(c_int, 0x8254, .hexadecimal);
pub const GL_UNKNOWN_CONTEXT_RESET = @import("std").meta.promoteIntLiteral(c_int, 0x8255, .hexadecimal);
pub const GL_RESET_NOTIFICATION_STRATEGY = @import("std").meta.promoteIntLiteral(c_int, 0x8256, .hexadecimal);
pub const GL_LOSE_CONTEXT_ON_RESET = @import("std").meta.promoteIntLiteral(c_int, 0x8252, .hexadecimal);
pub const GL_NO_RESET_NOTIFICATION = @import("std").meta.promoteIntLiteral(c_int, 0x8261, .hexadecimal);
pub const GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT = @as(c_int, 0x00000004);
pub const GL_COLOR_TABLE = @import("std").meta.promoteIntLiteral(c_int, 0x80D0, .hexadecimal);
pub const GL_POST_CONVOLUTION_COLOR_TABLE = @import("std").meta.promoteIntLiteral(c_int, 0x80D1, .hexadecimal);
pub const GL_POST_COLOR_MATRIX_COLOR_TABLE = @import("std").meta.promoteIntLiteral(c_int, 0x80D2, .hexadecimal);
pub const GL_PROXY_COLOR_TABLE = @import("std").meta.promoteIntLiteral(c_int, 0x80D3, .hexadecimal);
pub const GL_PROXY_POST_CONVOLUTION_COLOR_TABLE = @import("std").meta.promoteIntLiteral(c_int, 0x80D4, .hexadecimal);
pub const GL_PROXY_POST_COLOR_MATRIX_COLOR_TABLE = @import("std").meta.promoteIntLiteral(c_int, 0x80D5, .hexadecimal);
pub const GL_CONVOLUTION_1D = @import("std").meta.promoteIntLiteral(c_int, 0x8010, .hexadecimal);
pub const GL_CONVOLUTION_2D = @import("std").meta.promoteIntLiteral(c_int, 0x8011, .hexadecimal);
pub const GL_SEPARABLE_2D = @import("std").meta.promoteIntLiteral(c_int, 0x8012, .hexadecimal);
pub const GL_HISTOGRAM = @import("std").meta.promoteIntLiteral(c_int, 0x8024, .hexadecimal);
pub const GL_PROXY_HISTOGRAM = @import("std").meta.promoteIntLiteral(c_int, 0x8025, .hexadecimal);
pub const GL_MINMAX = @import("std").meta.promoteIntLiteral(c_int, 0x802E, .hexadecimal);
pub const GL_CONTEXT_RELEASE_BEHAVIOR = @import("std").meta.promoteIntLiteral(c_int, 0x82FB, .hexadecimal);
pub const GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH = @import("std").meta.promoteIntLiteral(c_int, 0x82FC, .hexadecimal);
pub const GL_SHADER_BINARY_FORMAT_SPIR_V = @import("std").meta.promoteIntLiteral(c_int, 0x9551, .hexadecimal);
pub const GL_SPIR_V_BINARY = @import("std").meta.promoteIntLiteral(c_int, 0x9552, .hexadecimal);
pub const GL_PARAMETER_BUFFER = @import("std").meta.promoteIntLiteral(c_int, 0x80EE, .hexadecimal);
pub const GL_PARAMETER_BUFFER_BINDING = @import("std").meta.promoteIntLiteral(c_int, 0x80EF, .hexadecimal);
pub const GL_CONTEXT_FLAG_NO_ERROR_BIT = @as(c_int, 0x00000008);
pub const GL_VERTICES_SUBMITTED = @import("std").meta.promoteIntLiteral(c_int, 0x82EE, .hexadecimal);
pub const GL_PRIMITIVES_SUBMITTED = @import("std").meta.promoteIntLiteral(c_int, 0x82EF, .hexadecimal);
pub const GL_VERTEX_SHADER_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x82F0, .hexadecimal);
pub const GL_TESS_CONTROL_SHADER_PATCHES = @import("std").meta.promoteIntLiteral(c_int, 0x82F1, .hexadecimal);
pub const GL_TESS_EVALUATION_SHADER_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x82F2, .hexadecimal);
pub const GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED = @import("std").meta.promoteIntLiteral(c_int, 0x82F3, .hexadecimal);
pub const GL_FRAGMENT_SHADER_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x82F4, .hexadecimal);
pub const GL_COMPUTE_SHADER_INVOCATIONS = @import("std").meta.promoteIntLiteral(c_int, 0x82F5, .hexadecimal);
pub const GL_CLIPPING_INPUT_PRIMITIVES = @import("std").meta.promoteIntLiteral(c_int, 0x82F6, .hexadecimal);
pub const GL_CLIPPING_OUTPUT_PRIMITIVES = @import("std").meta.promoteIntLiteral(c_int, 0x82F7, .hexadecimal);
pub const GL_POLYGON_OFFSET_CLAMP = @import("std").meta.promoteIntLiteral(c_int, 0x8E1B, .hexadecimal);
pub const GL_SPIR_V_EXTENSIONS = @import("std").meta.promoteIntLiteral(c_int, 0x9553, .hexadecimal);
pub const GL_NUM_SPIR_V_EXTENSIONS = @import("std").meta.promoteIntLiteral(c_int, 0x9554, .hexadecimal);
pub const GL_TEXTURE_MAX_ANISOTROPY = @import("std").meta.promoteIntLiteral(c_int, 0x84FE, .hexadecimal);
pub const GL_MAX_TEXTURE_MAX_ANISOTROPY = @import("std").meta.promoteIntLiteral(c_int, 0x84FF, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_OVERFLOW = @import("std").meta.promoteIntLiteral(c_int, 0x82EC, .hexadecimal);
pub const GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW = @import("std").meta.promoteIntLiteral(c_int, 0x82ED, .hexadecimal);
...
pub const GL_DEBUG_OUTPUT_SYNCHRONOUS_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8242, .hexadecimal);
pub const GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8243, .hexadecimal);
pub const GL_DEBUG_CALLBACK_FUNCTION_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8244, .hexadecimal);
pub const GL_DEBUG_CALLBACK_USER_PARAM_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8245, .hexadecimal);
pub const GL_DEBUG_SOURCE_API_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8246, .hexadecimal);
pub const GL_DEBUG_SOURCE_WINDOW_SYSTEM_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8247, .hexadecimal);
pub const GL_DEBUG_SOURCE_SHADER_COMPILER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8248, .hexadecimal);
pub const GL_DEBUG_SOURCE_THIRD_PARTY_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8249, .hexadecimal);
pub const GL_DEBUG_SOURCE_APPLICATION_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x824A, .hexadecimal);
pub const GL_DEBUG_SOURCE_OTHER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x824B, .hexadecimal);
pub const GL_DEBUG_TYPE_ERROR_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x824C, .hexadecimal);
pub const GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x824D, .hexadecimal);
pub const GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x824E, .hexadecimal);
pub const GL_DEBUG_TYPE_PORTABILITY_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x824F, .hexadecimal);
pub const GL_DEBUG_TYPE_PERFORMANCE_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8250, .hexadecimal);
pub const GL_DEBUG_TYPE_OTHER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8251, .hexadecimal);
pub const GL_DEBUG_TYPE_MARKER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8268, .hexadecimal);
pub const GL_DEBUG_TYPE_PUSH_GROUP_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8269, .hexadecimal);
pub const GL_DEBUG_TYPE_POP_GROUP_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x826A, .hexadecimal);
pub const GL_DEBUG_SEVERITY_NOTIFICATION_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x826B, .hexadecimal);
pub const GL_MAX_DEBUG_GROUP_STACK_DEPTH_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x826C, .hexadecimal);
pub const GL_DEBUG_GROUP_STACK_DEPTH_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x826D, .hexadecimal);
pub const GL_BUFFER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E0, .hexadecimal);
pub const GL_SHADER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E1, .hexadecimal);
pub const GL_PROGRAM_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E2, .hexadecimal);
pub const GL_VERTEX_ARRAY_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x8074, .hexadecimal);
pub const GL_QUERY_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E3, .hexadecimal);
pub const GL_PROGRAM_PIPELINE_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E4, .hexadecimal);
pub const GL_SAMPLER_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E6, .hexadecimal);
pub const GL_MAX_LABEL_LENGTH_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x82E8, .hexadecimal);
pub const GL_MAX_DEBUG_MESSAGE_LENGTH_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x9143, .hexadecimal);
pub const GL_MAX_DEBUG_LOGGED_MESSAGES_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x9144, .hexadecimal);
pub const GL_DEBUG_LOGGED_MESSAGES_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x9145, .hexadecimal);
pub const GL_DEBUG_SEVERITY_HIGH_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x9146, .hexadecimal);
pub const GL_DEBUG_SEVERITY_MEDIUM_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x9147, .hexadecimal);
pub const GL_DEBUG_SEVERITY_LOW_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x9148, .hexadecimal);
pub const GL_DEBUG_OUTPUT_KHR = @import("std").meta.promoteIntLiteral(c_int, 0x92E0, .hexadecimal);
...
pub inline fn glDebugMessageControlKHR(arg_2443: GLenum, arg_2444: GLenum, arg_2445: GLenum, arg_2446: GLsizei, arg_2447: [*c]const GLuint, arg_2448: GLboolean) void {
    return glad_glDebugMessageControlKHR.?(arg_2443, arg_2444, arg_2445, arg_2446, arg_2447, arg_2448);
}
pub inline fn glDebugMessageInsertKHR(arg_2449: GLenum, arg_2450: GLenum, arg_2451: GLuint, arg_2452: GLenum, arg_2453: GLsizei, arg_2454: [*c]const GLchar) void {
    return glad_glDebugMessageInsertKHR.?(arg_2449, arg_2450, arg_2451, arg_2452, arg_2453, arg_2454);
}
pub inline fn glDebugMessageCallbackKHR(arg_2455: GLDEBUGPROCKHR, arg_2456: ?*const c_void) void {
    return glad_glDebugMessageCallbackKHR.?(arg_2455, arg_2456);
}
pub inline fn glGetDebugMessageLogKHR(arg_2457: GLuint, arg_2458: GLsizei, arg_2459: [*c]GLenum, arg_2460: [*c]GLenum, arg_2461: [*c]GLuint, arg_2462: [*c]GLenum, arg_2463: [*c]GLsizei, arg_2464: [*c]GLchar) GLuint {
    return glad_glGetDebugMessageLogKHR.?(arg_2457, arg_2458, arg_2459, arg_2460, arg_2461, arg_2462, arg_2463, arg_2464);
}
pub inline fn glPushDebugGroupKHR(arg_2465: GLenum, arg_2466: GLuint, arg_2467: GLsizei, arg_2468: [*c]const GLchar) void {
    return glad_glPushDebugGroupKHR.?(arg_2465, arg_2466, arg_2467, arg_2468);
}
pub inline fn glPopDebugGroupKHR() void {
    return glad_glPopDebugGroupKHR.?();
}
pub inline fn glObjectLabelKHR(arg_2469: GLenum, arg_2470: GLuint, arg_2471: GLsizei, arg_2472: [*c]const GLchar) void {
    return glad_glObjectLabelKHR.?(arg_2469, arg_2470, arg_2471, arg_2472);
}
pub inline fn glGetObjectLabelKHR(arg_2473: GLenum, arg_2474: GLuint, arg_2475: GLsizei, arg_2476: [*c]GLsizei, arg_2477: [*c]GLchar) void {
    return glad_glGetObjectLabelKHR.?(arg_2473, arg_2474, arg_2475, arg_2476, arg_2477);
}
pub inline fn glObjectPtrLabelKHR(arg_2478: ?*const c_void, arg_2479: GLsizei, arg_2480: [*c]const GLchar) void {
    return glad_glObjectPtrLabelKHR.?(arg_2478, arg_2479, arg_2480);
}
pub inline fn glGetObjectPtrLabelKHR(arg_2481: ?*const c_void, arg_2482: GLsizei, arg_2483: [*c]GLsizei, arg_2484: [*c]GLchar) void {
    return glad_glGetObjectPtrLabelKHR.?(arg_2481, arg_2482, arg_2483, arg_2484);
}
pub inline fn glGetPointervKHR(arg_2485: GLenum, arg_2486: [*c]?*c_void) void {
    return glad_glGetPointervKHR.?(arg_2485, arg_2486);
}
